...
let AuthService = class AuthService {
    ...
    login(username, password) {
        ...
        return this.http.post(`http://localhost:3030/user/authenticate`, { username, password })
...
let LBCardService = class LBCardService {
    constructor(notif, http) {
        this.notif = notif;
        this.http = http;
    }
...
let NotificationService = class NotificationService {
    ...
    showNotif(message, action = 'error', duration = 4000) {
    ...
    notImplementedWarning(message, duration = 4000) {
        // @ts-ignore
...
const routes = [{ path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_3__["HomeComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
...
/* harmony import */ var igniteui_angular__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! igniteui-angular */ "./node_modules/igniteui-angular/fesm2015/igniteui-angular.js");
...
let EditComponent = class EditComponent {
    constructor(route, notifService, auth, fighterService, userSerivce) {
        this.route = route;
...
let FighterComponent = class FighterComponent {
    constructor(router, auth, notifService, userSerivce) {
        this.router = router;
        this.auth = auth;
        this.notifService = notifService;
        this.userSerivce = userSerivce;
...
let HomeComponent = class HomeComponent {
    constructor(userService, fighterService, notifService, authService) {
...
let LBCardComponent = class LBCardComponent {
    constructor(auth) {
        this.auth = auth;
        this.rank = 0;
...
LBCardComponent.ctorParameters = () => [
...
let LeaderboardComponent = class LeaderboardComponent {
    constructor(lbcardService, notifService) {
...
let LoginComponent = class LoginComponent {
    ...
    login() {
        ...
        this.authService.login(this.username, this.password)
            ...
            this.notif.showNotif('Username or password is incorrect', 'dismiss');
...
let MyGSPComponent = class MyGSPComponent {
    constructor(userService, notifService, authService, fighterService) {
        this.userService = userService;
        this.notifService = notifService;
        this.authService = authService;
        this.fighterService = fighterService;
    ...
    deleteFighter(date) {
        ...
        console.log(date);
        console.log(this.authService.currentUserValue.username);
        this.fighterService.delete(date, this.authService.currentUserValue.username).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(() => {
            this.fighters = null;
            this.loadAllFighters();
